  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required name='email' value={formData.email} onChange={onChangeHandler} className='input' placeholder='Email address' />
        ...
        <div className='flex gap-3'>
          ...
          <input name='state' value={formData.state} onChange={onChangeHandler} className='input' placeholder='State' />
        </div>
        ...
        <input required name='phone' value={formData.phone} onChange={onChangeHandler} className='input' placeholder='Phone' />
